...
import { databaseConnection, pgp, postgresConnection } from "./DbConnection.js"
...
dbConnection.postgresConnection = postgresConnection
dbConnection.dbConnection = databaseConnection
dbConnection.pgp = pgPromise()
// Must be first to initialize
initializeCommons(pgp)
registerDBAdmin(app, DbConnection.getInstance(), postgresConnection, pgp)
registerBulkApi(app, DbConnection.getInstance(), pgp)
registerInspection(app, databaseConnection, pgp)
registerAdditionalApi(app, databaseConnection, pgp)
registerLanguagesApi(app, databaseConnection, pgp)
